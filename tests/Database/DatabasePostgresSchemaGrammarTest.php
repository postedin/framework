...
class DatabasePostgresSchemaGrammarTest extends PHPUnit_Framework_TestCase {
	...
	public function testAddingDateTime()
	{
		...
		$this->assertEquals(1, count($statements));
		$this->assertEquals('alter table "users" add column "foo" timestamptz not null', $statements[0]);
	}
	...
	public function testAddingTimeStamps()
	{
		...
		$this->assertEquals(1, count($statements));
		$this->assertEquals('alter table "users" add column "created_at" timestamptz not null, add column "updated_at" timestamptz not null', $statements[0]);
	}
